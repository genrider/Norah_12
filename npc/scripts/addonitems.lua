...
npcHandler:addModule(shopModule)
	...
	shopModule:addSellableItem({'lizard scale'}, 5881, 220, 'lizard scale')
	shopModule:addSellableItem({'lizard leather'}, 5876, 200, 'lizard leather')
	shopModule:addSellableItem({'green dragon scale'}, 5920, 200, 'green dragon scale')
	shopModule:addSellableItem({'green dragon leather'}, 5877, 150, 'green dragon leather')
	...
	shopModule:addSellableItem({'iron ore'}, 5880, 300, 'iron ore')
	...
	shopModule:addSellableItem({'perfect behemoth fang'}, 5893, 350, 'perfect behemoth fang')
	shopModule:addSellableItem({'red dragon leather'}, 5948, 250, 'red dragon leather')
	shopModule:addSellableItem({'red dragon scale'}, 5882, 300, 'red dragon scale')
	...
	shopModule:addSellableItem({'magic sulphur'}, 5904, 4000, 'magic sulphur')
