...
local function greetCallback(cid)
	...
	if player:getStorageValue(Storage.Ruiny.Mission01) == 7 then
		npcHandler:setMessage(MESSAGE_GREET, "What brings you here this time, general {information}, {transform}, {improve} or {create}?")
	else
