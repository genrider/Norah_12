...
local bosses = {
	...
	[3213] = {bossName = 'the bloodtusk', storage = 3504, playerPosition = Position(698, 490, 11), bossPosition = Position(602, 491, 11), centerPosition = Position(600, 491, 11), rangeX = 9, rangeY = 6, flamePosition = Position(663, 523, 10)},
